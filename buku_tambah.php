...
<div class="card-container" style="max-width: 700px; margin: 0 auto;">
    ...
    <form id="form-tambah-buku">
        ...
        <div style="margin-bottom: 25px;">
            <label style="display:block; margin-bottom:8px; font-weight:600; color:#475569;">Cover Buku (Opsional)</label>
        ...
        <button type="submit" class="btn-primary" style="width: 100%;">Simpan Buku ke Database</button>
    </form>
</div>
